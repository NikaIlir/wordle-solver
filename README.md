...
### How to play
Each time you press the icon of this extension or by pressing command `CTRL + U` for Windows and `Command + U` for Mac, it will suggest the best possibility words for the current line.
